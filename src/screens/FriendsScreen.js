    ...
    return (
        <LinearGradient colors={['#04090f', '#060c1a', '#04090f']} style={{ flex: 1 }}>
            ...
            <Animated.View style={{
                ...
                backgroundColor: 'rgba(87, 208, 245, 0.4)',
                transform: [{ scale: orb1Scale }],
            }} />
            <Animated.View style={{
                position: 'absolute', bottom: '12%', left: '-20%',
                width: W * 0.8, height: W * 0.8, borderRadius: W * 0.4,
                backgroundColor: 'rgba(112, 121, 207, 0.5)',
                transform: [{ scale: orb2Scale }],
            }} />
            <Animated.View style={{
                position: 'absolute', top: '40%', left: '10%',
                width: 120, height: 120, borderRadius: 60,
                backgroundColor: 'rgba(253, 9, 9, 0.46)', opacity: 0.3,
                transform: [{ scale: orb1Scale }],
            }} />

            <Animated.View style={{
                position: 'absolute', top: '57%', left: '65%',
                width: 120, height: 120, borderRadius: 60,
                backgroundColor: 'rgba(183, 240, 10, 0.46)', opacity: 0.3,
                transform: [{ scale: orb1Scale }],
            }} />
            ...
            <Animated.ScrollView
                ...
                {/* Icon badge */}
                <View style={{
                    width: 100, height: 100, borderRadius: 445,
                    backgroundColor: 'rgba(9, 192, 248, 0.4)',
                ...
                {/* Feature pills */}
                {['🎬  Watch movies with friends live', '🌐  See who is online right now', '✉️  Message your circle instantly'].map((txt, i) => (
                    <View key={i} style={{
                ...
                <TouchableOpacity
                    style={{
                        width: '100%', height: 50, borderRadius: 17,
                ...
                <Text style={{ color: 'rgba(122,143,173,0.4)', fontSize: 12, marginBottom: 30, textAlign: 'center' }}>
...
export default function FriendsScreen({ navigation }) {
    ...
    console.log('ready value', authReady);
